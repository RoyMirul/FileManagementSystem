...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-12"><h4><b><p style="color:white">Folders</p></b></h4></div>
		</div>
		<hr>
		<div class="row">
			<?php 
			...
			?>				
				<div class="card col-md-3.5 mt-2 ml-2 mr-2 mb-2 folder-item" data-id="<?php echo $row['id'] ?>">
					<a href="index.php?page=files&fid=<?=$row['id'];?>">
						<div class="card-body">
				...
				<div class="card-body">
					<table id="t01" width="100%">
						<tr>
							...
							<th width="20%" class="">File Code</th>
					...
					?>
						<tr class='file-item' data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
							...
							<td><i class="to_file"><?php echo $row['file_code'] ?></i></td>
	...
	$(document).ready(function(){
		$('#search').keyup(function(){
			...
			$('.to_folder').each(function(){
				...
				if(val.includes(_f))
					$(this).closest('.card.folder-item').toggle(true);
				else
					$(this).closest('.card.folder-item').toggle(false);				
			});
			$('.file-item').each(function(){
				var val  = $(this).text().toLowerCase();
				if(val.includes(_f))
					$(this).closest('.file-item').toggle(true);
				else
					$(this).closest('.file-item').toggle(false);
			})
		})
	})
