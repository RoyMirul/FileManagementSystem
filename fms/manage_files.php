...
<div class="container-fluid">
	...
	<?php endif; ?>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="file_code" id="file_code" value="<?php echo isset($meta['file_code']) ? $meta['file_code'] :'' ?>">
		</div>
		<div class="form-group">
			<label for="is_public" class="control-label"><input type="checkbox" name="is_public" id="is_public" checked="checked"><i> Share to All Users</i></label>
		</div>
